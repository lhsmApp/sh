...
public class StaffDetailModel {
	...
	private Double POST_SALY;
	private Double BONUS; 
	private Double CASH_BONUS; 
	private Double WORK_OT; 
	private Double BACK_SALY; 
	private Double RET_SALY; 
	private Double CHK_CASH; 
	private Double INTR_SGL_AWAD; 
	private Double SENY_ALLE; 
	private Double POST_ALLE; 
	private Double NS_ALLE; 
	private Double AREA_ALLE; 
	private Double EXPT_ALLE; 
	private Double TECH_ALLE; 
	private Double LIVE_EXPE; 
	private Double LIVE_ALLE; 
	private Double LEAVE_DM; 
	private Double HOUSE_ALLE; 
	private Double ITEM_ALLE; 
	private Double MEAL_EXPE;
	private Double TRF_ALLE; 
	private Double TEL_EXPE; 
	private Double HLDY_ALLE; 
	private Double KID_ALLE; 
	private Double COOL_EXPE; 
	private Double EXT_SGL_AWAD; 
	private Double PRE_TAX_PLUS; 
	private Double GROSS_PAY; 
	private Double ENDW_INS; 
	private Double UNEMPL_INS; 
	private Double MED_INS; 
	private Double CASD_INS; 
	private Double HOUSE_FUND; 
	private Double SUP_PESN; 
	private Double TAX_BASE_ADJ;
	private Double ACCRD_TAX; 
	private Double AFTER_TAX; 
	private Double ACT_SALY; 
	private Double GUESS_DIFF; 
	private Double CUST_COL1; 
	private Double CUST_COL2; 
	private Double CUST_COL3; 
	private Double CUST_COL4; 
	private Double CUST_COL5; 
	private Double CUST_COL6; 
