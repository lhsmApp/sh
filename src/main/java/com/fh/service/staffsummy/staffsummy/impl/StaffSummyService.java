...
public class StaffSummyService implements StaffSummyManager{
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("StaffSummyMapper.delete", pd);
	}
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("StaffSummyMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("StaffSummyMapper.listAll", pd);
	}
	...
	public void deleteAll(String[] ArrayDATA_IDS)throws Exception{
		dao.delete("StaffSummyMapper.deleteAll", ArrayDATA_IDS);
	}
